...
- **Catalog** of 72 procedurally modeled pieces across 11 categories (seating, beds, tables, storage, workspace, decor, toys, lighting, plants, rugs, wall art), each with live-rendered 3D thumbnails, plus live search across all categories. You can also **import your own .glb/.gltf models** (up to 6 MB) — they're auto-scaled to furniture size, grounded, placeable like any item, and embedded in saves and room files.
