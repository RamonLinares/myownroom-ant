...
- **Catalog** of 117 procedurally modeled pieces across 14 categories — seating, beds, tables, storage, a full kitchen set (counters, island with bar stools, sink, gas & induction stoves, double oven, extractor hood, family/mini fridges, microwave, air fryer, pizza oven, rice cooker, kettle, pots, pans and mugs), workspace, decor, toys, lighting, plants, rugs, wall art, a seasonal pack, and a 90s-sitcom living-room set (big café sofa, foosball, worn recliner, leather lounge set, baby grand, telescope, wall bike, retro fridge…) — each with live-rendered 3D thumbnails, plus live search, measured size labels, and a Recent tab of your latest picks. You can also **import your own .glb/.gltf models** (up to 6 MB) — they're auto-scaled to furniture size, grounded, placeable like any item, and embedded in saves and room files.
...
- **Room assistant**: the ✨ button opens a five-question interview — what's the room for (living room, bedroom, kitchen, office, kids' room, or studio flat), which look, how big, how lived-in, plus a personal touch (plants, reading nook, music corner, games, party) — and builds a fully furnished room from the answers as a new room in your home, with its door auto-linked back to where you came from. Items are measured and dodge each other, grand rooms sometimes come L-shaped, and the toast offers 🎲 Shuffle and 🗑 Discard. Your answers are remembered: reopening the assistant offers one-tap "shuffle this room" / "another like last time" shortcuts.
- **Famous rooms**: hand-curated preset apartments in the 🏠 panel — one tap builds them as a new room in your home, door linked back. Ships with **The Sitcom Apartment**, a 90s NYC one-bedroom about nothing: blue couch and armchair, kitchen peninsula with blue bar stools, cereal on the fridge, a computer desk by the window, and a green bike hung on the wall.
...
src/
  ...
  game/assistant.ts  question-driven procedural room generator (✨ assistant)
